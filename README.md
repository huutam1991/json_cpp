...
# Usage
Very simple, just copy 2 folders **src/json** and **src/cache** to your project, then put **#include <json/json.h>** to the file's header (pls take a look at **src/main.cpp**). That's it !!!
